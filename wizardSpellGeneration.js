...
var other = JSON.parse(fs.readFileSync("dndSpells.json"))

other = other.map(spell => {
    var max = 668
    console.log(spell.title, spell.description[0].length)
...
// console.log(JSON.stringify(other.slice(0, 4), null, 2))
