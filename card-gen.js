...
<div class="grid-container card card-background {{colour}}">
    ...
    var compileData = {
        ...
        description: e => {
            if (e.description[0].length > maxLength) {
                console.log(e.title, "too long", e.description[0].length)
                e.description[0] = e.description[0].substring(0, maxLength)
                e.description[0] += "... [Clipped, please see website]"
